#
# Module manifest for module 'dbatools.base'
#
...
@{
    ...
    RootModule             = 'dbatools.base.psm1'

    # Version number of this module.
    ModuleVersion          = '2.0.0'

    # ID used to uniquely identify this module
    GUID                   = 'f8e72f2c-ad3d-4959-b847-4bf2840002b1'
    ...
    # Need dbatools to work on PS 3.0 or PS 4.0? Use dbatools.legacy. It's
    # the same module, it just uses a different manifest.
